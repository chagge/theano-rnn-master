...
class ModelLSTMLM(object):
    def __init__(self, vocab_size, emb_dim, hidden_size, act_func, n_out, pretrain_file):
    ...
    def buildModel(self):
        ...
        self.classifier = RNNLM(self.x, self.activation, self.in_vocab_size, self.emb_dim, self.hidden_size, self.n_out, pretrain_file)
        self._initSGD()
...
class RNNLM(object):
    ...
    def __init__(self, input, activation, in_vocab_size, emb_dim, hidden_size, n_out, pretrain_file):
        ...
        rnn_layer = RNNLayer(prev_layer.output, self.emb_dim, self.hidden_size, activation)
        ...
        hidden_params=rnn_layer.params
        
        
        

        # softmax layer
        self.softmaxLayer = SoftmaxLayer(self.rnn_layer.output, hidden_size, n_out)
