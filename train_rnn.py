...
def process_command_line():
    ...
    parser.add_argument('--hidden_layer', dest='hidden_layer', type=int,
                        default='512', help='hidden layers, e.g. 512 (default=512)')
...
if __name__=='__main__':
    ...
    rnnlm_model = model_rnnlm.ModelRNNLM(vocab_size, emb_dim, hidden_layer, act_func, vocab_size, pretrain_file)
    rnnlm_model.buildModel()
